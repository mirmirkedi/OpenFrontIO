...
const INPUT_WATERMARKS: Record<string, string> = {
  "game_settings.max_timer": assetUrl("images/DoomsdayClockSkull.svg"),
  "game_settings.gold_multiplier": assetUrl("images/GoldCoinIcon.svg"),
  "game_settings.starting_gold": assetUrl("images/DonateGoldIconWhite.svg"),
  "game_settings.custom_alliances": assetUrl("images/AllianceIconWhite.svg"),
};

function renderInputWatermark(iconUrl?: string) {
  if (!iconUrl) return nothing;
  return html`
    <img
